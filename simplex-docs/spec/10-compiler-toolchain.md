...
|-----------|--------|---------|-------------|
| **sxc** | `sxc` | v0.16.0 | Simplex Compiler - compiles `.sx` source to native executables |
| **sxpm** | `sxpm` | v0.16.0 | Package manager with dependency resolution |
| **cursus** | `cursus` | v0.16.0 | Bytecode VM with garbage collection |
| **sxdoc** | `sxdoc` | v0.16.0 | Documentation generator |
| **sxlsp** | `sxlsp` | v0.16.0 | Language Server Protocol implementation |
| **sxfmt** | `sxfmt` | v0.16.0 | Code formatter with configurable styles |
| **sxlint** | `sxlint` | v0.16.0 | Static linter with extensible rules |
