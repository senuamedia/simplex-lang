...
Simplex v0.12.0 introduces **self-learning annealing** - temperature schedules that optimize themselves through gradient descent. This tutorial teaches you how to build systems where the cooling rate learns alongside the model.
