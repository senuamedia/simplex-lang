...
## High-Performance Inference (v0.11.0)

Starting with v0.11.0, Simplex provides native llama.cpp integration for optimized inference.
...
## Self-Learning Optimization (v0.11.0)
...
| `InferencePipeline` | High-performance batched inference (v0.11.0) |
| `LearnableSchedule` | Self-learning optimization schedules (v0.11.0) |
