...
## High-Performance Inference (v0.13.0)

Starting with v0.13.0, Simplex provides native llama.cpp integration for optimized inference.
...
| `InferencePipeline` | High-performance batched inference (v0.13.0) |
| `LearnableSchedule` | Self-learning optimization schedules (v0.13.0) |
